...
contract TokenTest is Test {
    ...
    function testSetCap() public {
        uint256 newCap = 20_000_000_000 * 10 ** 18; // Ensure correct decimal scaling
        vm.prank(owner);
        token.setCap(newCap);
    ...
    function testPermit() public {
        ...
        uint256 user1PrivateKey = 0xA11CE; // Example private key (replace with your own key)
        address user1 = vm.addr(user1PrivateKey); // Derive the address from the private key
        ...
        // Get the chain id and the domain separator from the contract
